...
public class ResearchAPI extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String output = researchObj.insertResearch(request.getParameter("researcheName"), 
				request.getParameter("researchInstitute"),
				request.getParameter("researchDuration"),
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		paras.get("researcheName").toString(),
		paras.get("researchInstitute").toString(),
		paras.get("researchDuration").toString(),
